...
sys.path.insert(0, os.path.abspath("../../pynenc_redis"))

DISTRIBUTION_METADATA = importlib.metadata.metadata("pynenc-redis")

# -- Project information -----------------------------------------------------
author = "Luis Diaz"
project = "pynenc-redis"
...
autodoc2_packages = [{"path": "../pynenc_redis"}]
...
html_theme = "furo"
html_title = "Pynenc Redis Plugin"
...
html_theme_options: dict[str, Any] = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/pynenc/pynenc-redis",
            "html": """
    ...
    "source_repository": "https://github.com/pynenc/pynenc-redis/",
    "source_branch": "main",
